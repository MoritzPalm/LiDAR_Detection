...
def detect(original_image, min_score, max_overlap, top_k, suppress=None):
    ...
    :param min_score: minimum threshold for a detected box to be considered a match for
    a certain class
    :param max_overlap: maximum overlap two boxes can have so that the one with
    the lower score is not suppressed via Non-Maximum Suppression (NMS)
...
if __name__ == '__main__':
    ...
    img_path = f"{IMAGE_PATH}/frame_000000.PNG"
